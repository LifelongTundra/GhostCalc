...
Currently the Calculate button DOES NOT do anything. It was original going to update the list however it now auto updates after every button press and now serves the purpose of a debugging tool. Again unless you downloaded and are running the code through a Java IDE it will do nothing.
